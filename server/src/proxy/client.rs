...
impl GeminiClient {
    /// 创建新的 Gemini 客户端
    pub fn new(timeout_secs: u64, proxy_url: Option<&str>) -> Self {
        Self {
            client: create_http_client(timeout_secs, proxy_url),
        }
    }
}

/// 创建 HTTP 客户端
fn create_http_client(timeout_secs: u64, proxy_url: Option<&str>) -> Client {
