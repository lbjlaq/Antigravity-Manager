...
const COMMAND_MAPPING: Record<string, { url: string; method: 'GET' | 'POST' | 'DELETE' | 'PATCH' }> = {
  ...
  'get_codex_provider_status': { url: '/api/proxy/codex/status', method: 'GET' },
  'refresh_codex_models': { url: '/api/proxy/codex/models/fetch', method: 'POST' },
  'start_codex_provider': { url: '/api/proxy/codex/start', method: 'POST' },
  'stop_codex_provider': { url: '/api/proxy/codex/stop', method: 'POST' },
  'restart_codex_provider': { url: '/api/proxy/codex/restart', method: 'POST' },
